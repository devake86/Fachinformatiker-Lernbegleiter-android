# Fachinformatiker Lernbegleiter (Android)

Eine Java-basierte Lern-App in Quizform für Android zur ergänzenden Prüfungsvorbereitung für angehende Fachinformatikerinnen und Fachinformatiker, insbesondere für AP1 und perspektivisch AP2. Die Fragen werden JSON-/Gson-basiert geladen und verarbeitet.

Die Android-Version nutzt eine interne SQLite-Datenbank zur lokalen Speicherung von Lernstand, korrekt beantworteten Fragen und persistentem Fehlertraining. Zusätzlich werden Benutzereinstellungen wie Custom Light-/Dark-Mode, „Letzte Auswahl“ und die bevorzugte Bedienrichtung für rechts- oder linkshändige Nutzung lokal gespeichert.
...
Voraussetzungen:
- Android SDK 26 / Android 8.0 Oreo oder kompatibel
...
Eine passende Desktop-Version wurde mit ähnlicher Struktur und Logik umgesetzt, um Wartung, Weiterentwicklung und spätere Plattform-Ports zu erleichtern.

Motivation:
- Java- und OOP-Konzepte wurden in den offiziellen Lernfeldern nur begrenzt vertieft.
- Es bestand Bedarf an einer mobilen, effizienten und interaktiven Lernmöglichkeit als Ergänzung zu langsameren Lernmethoden wie Büchern oder Karteikarten.
- Tägliche Fahrtzeiten sollten sinnvoll für Prüfungsvorbereitung genutzt werden können, ohne in öffentlichen Verkehrsmitteln mit auffälligem Lernmaterial arbeiten zu müssen.

Lösung:
- Mobile Lern-App für Android-Geräte
- Kurze Lernrunden und schnelle Wiederholung unterwegs
...
- Interne SQLite-basierte Lernstandsspeicherung:
  ...
  - Der Lernstand bleibt nach App-Neustart erhalten.
...
- Light- und Dark-Mode
- Android-Version wurde für einhändige Daumenbedienung optimiert
- Android-spezifische UI-Optionen wie linkshändige Bedienung
...
- Android-Entwicklung kennenlernen
- UI/UX für mobile Anwendungen besser verstehen
- Mit JSON-Datenstrukturen arbeiten
- Ein praktisch nutzbares Lernwerkzeug für die echte Prüfungsvorbereitung bauen
- Plattformübergreifende Projektstruktur aufbauen und pflegen
- Lokale Persistenz mit interner SQLite-Datenbank umsetzen
...
- Android-Hauptmenü mit festen Schnellzugriffen für Quiz Auswahl, Letzte Auswahl und Fehlertraining überarbeitet
...
- Persistentes Fehlertraining über interne SQLite-Datenbank:
